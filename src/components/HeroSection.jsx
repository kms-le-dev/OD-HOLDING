  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        ...
        Notre mission est de concevoir des logiciels sur mesure, 
        performants et intuitifs, qui répondent précisément à vos besoins.
      </p>
      ...
      <div className="flex mt-10 justify-center">
        ...
        >
          ...
          Votre vidéo peut pas être supporté.
        </video>
        <video
          autoPlay
          loop
